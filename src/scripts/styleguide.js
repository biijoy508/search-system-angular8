function laddaNerStyleguide() {
  if (location) {
    ...
    if (utvmiljo === true || localhost === true || mobilityguard_utvmiljo === true) {
      ...
      const jsUrl = 'https://cdnutv.jordbruksverket.se/designsystem/9.1.1/package/dist/release/sjv-komponentbibliotek.js';
      const cssUrl = 'https://cdnutv.jordbruksverket.se/designsystem/9.1.1/package/dist/release/sjv-komponentbibliotek.css';
