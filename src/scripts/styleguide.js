function laddaNerStyleguide() {
  if (location) {
    ...
    if (utvmiljo === true || localhost === true || mobilityguard_utvmiljo === true) {
      ...
      const jsUrl = 'https://cdnutv.jordbruksverket.se/designsystem/10.0.0-SNAPSHOT/package/dist/release/sjv-komponentbibliotek.js';
      const cssUrl = 'https://cdnutv.jordbruksverket.se/designsystem/10.0.0-SNAPSHOT/package/dist/release/sjv-komponentbibliotek.css';
